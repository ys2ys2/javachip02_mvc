...
<div class="journal-section">
    <!-- 제목 -->
    <div class="section-title1">인천 여행기</div>
...
<div class="schedule-section">
    ...
    <div class="schedule-main-title">인천 여행일정</div>
...
<div class="hot-spot-section">
    ...
    <div class="hot-spot-main-title">인천 여행뽈뽈</div>
...
<div class="hot-spot-section">
    ...
    <div class="hot-spot-main-title1">인천 핫플</div>
...
<div class="restaurant-section">
    ...
    <div class="restaurant-main-title">인천 맛집</div>
...
<jsp:include page="Festival_Incheon.jsp" />
