    ...
    <div class="t_minibody">
        <div class="t_title-container">
         <%-- <c:forEach var="event" items="${events}" varStatus="vs"> 행사 데이터를 여러개 가겨올 때 사용하는 반복문--%>
	      <h2>제목 : ${events[2].TITLE}</h2> <!-- EL로 제목 표시 -->
	      <h3>장소 : ${events[2].GUNAME}</h3> <!--  EL로 장소 표시 -->
	      <h4>소제목 : 행복의 파랑새</h4>
	        </div>
  ...
  function shareToPlatform(platform) {
    ...
    toggleSharePopup(); // 공유 후 팝업 닫기
        ...
        <div id="photos" class="slider-container">
            <div class="slider">
               <img src="${events[2].MAIN_IMG}" alt="이미지" class="slide">
            </div>
        </div>
...
<div id="eventDetails">
    <div class="details-left">
         <p class="two-line-link">
          ...
          <a href="${events[2].ORG_LINK}" target="_blank" class="link-wrap">
            https://booking.naver.com<br>
            <span class="indented-link">/booking/5/bizes/16695</span>
          </a>
    </p>
    <p><span class="bullet">•</span> <strong>전시 종류:</strong> ${events[2].CODENAME}</p>
        <p><span class="bullet">•</span> <strong>예약 시작:</strong> ${events[2].RGSTDATE}</p>
    </div>
    <div class="details-right">
        <p><span class="bullet">•</span> <strong>날짜:</strong> ${events[2].DATE}</p>
        <p><span class="bullet">•</span> <strong>연령:</strong> ${events[2].USE_TRGT}</p>
        <p><span class="bullet">•</span> <strong>가격:</strong> ${events[2].USE_FEE}</p>
        <p><span class="bullet">•</span> <strong>장소(홀):</strong> ${events[2].PLACE}</p>
    </div>
</div>
    ...
    <div class="festival-slider">
        ...
        <div class="festival-slide">
            ...
            <div class="festival-info">
                ...
                <button class="action-button" data-href="${pageContext.request.contextPath}/Festiva/Event">바로가기</button>
            </div>
        </div>
        ...
        <div class="festival-slide">
            ...
            <div class="festival-info">
                <h3>오페라 갈라</h3>
               <button class="action-button" data-href="${pageContext.request.contextPath}/Festiva1/Event4">바로가기</button>
            </div>
        </div>
        ...
        <div class="festival-slide">
            <a href="${pageContext.request.contextPath}/Festival/Event2">
                <img src="${pageContext.request.contextPath}/resources/images/Festival_Seoul2.jpg" alt="Festival Image 3">
            </a>
            <div class="festival-info">
                <h3>파리나무십자가</h3>
               <button class="action-button" data-href="${pageContext.request.contextPath}/Festiva1/Event2">바로가기</button>
            </div>
        </div>
    </div>
</div>
