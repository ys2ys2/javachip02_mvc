  ...
  function shareToPlatform(platform) {
    ...
    toggleSharePopup(); // 공유 후 팝업 닫기
        ...
        <div id="photos" class="slider-container">
            <div class="slider">
               <img src="${events[1].MAIN_IMG}" alt="이미지" class="slide">
            </div>
        </div>
...
<div id="eventDetails">
    <div class="details-left">
         <p class="two-line-link">
          ...
          <a href="${events[1].ORG_LINK}" target="_blank" class="link-wrap">
            https://booking.naver.com<br>
            <span class="indented-link">/booking/5/bizes/16695</span>
          </a>
    </p>
    <p><span class="bullet">•</span> <strong>전시 종류:</strong> ${events[1].CODENAME}</p>
        <p><span class="bullet">•</span> <strong>예약 시작:</strong> ${events[1].RGSTDATE}</p>
    </div>
    <div class="details-right">
        <p><span class="bullet">•</span> <strong>날짜:</strong> ${events[1].DATE}</p>
        <p><span class="bullet">•</span> <strong>연령:</strong> ${events[1].USE_TRGT}</p>
        <p><span class="bullet">•</span> <strong>가격:</strong> ${events[1].USE_FEE}</p>
        <p><span class="bullet">•</span> <strong>장소(홀):</strong> ${events[1].PLACE}</p>
    </div>
</div>
