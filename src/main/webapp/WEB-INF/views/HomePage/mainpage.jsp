...
<body>
    ...
    <div class="header-container">
      ...
      <nav>
        <ul>
          ...
          <li><a href="${pageContext.request.contextPath}/Community/c_main" data-ko="커뮤니티" data-en="Community">커뮤니티</a></li>
  ...
  <div class="main-container">
    ...
    <div class="hotplace-item">
		<a href="${pageContext.request.contextPath}/Member/login" class="hotplace-item">
    ...
    <div class="hotplace-item">
      <a href="${pageContext.request.contextPath}/Community/c_main" class="hotplace-item">
