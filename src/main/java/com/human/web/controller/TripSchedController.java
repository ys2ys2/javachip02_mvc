...
import com.human.web.service.TripSchedService;
...
public class TripSchedController {
    ...
    public String saveTripSchedule(HttpSession session, 
        ...
        // 세션에 member 정보가 없으면 로그인 페이지로 리다이렉트
        if (member == null) {
        ...
        tripSchedVO.setDayNumbers(convertStringArrayToIntArray(dayNumbers));  // String 배열을 int 배열로 변환
        tripSchedVO.setCityNames(cityNames);
